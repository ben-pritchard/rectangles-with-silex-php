<?php
    ...
    $app->get("/", function() {
        return "<a href='/new_rectangle'>Make a new rectangle</a>";
    });
    ...
    $app->get("/view_rectangle", function() {
        ...
        if ($my_rectangle->isSquare()) {
            return "<h1>Congratulations, you made a square! Its area is $area square units.</h1>
            <a href='/new_rectangle'>Back</a>";
        } else {
            return "<h1>You made a rectangle with an area of $area square units.</h1>
                    <a href='/new_rectangle'>Back</a>";
        }
    });
